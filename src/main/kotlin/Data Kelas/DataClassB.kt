package `Data Kelas`
//Percobaan Data class hashCode() and equals() methods
//Jika dua buah objek memiliki referensi objek yang sama, maka kedua objek tersebut juga memiliki nilai hashCode yang sama
fun main() {
